...
int main() {
    ...
    Game game(p1, p2);
    game.playAll();
    int xasd = p1.stacksize();
    int sad = p2.stacksize();
    int asd = p1.cardesTaken();
    int asndj = p2.cardesTaken();
    int adasdasd = p1.cardesTakenokok();
    int adasd12312asd = p1.cardesTakenokok();
